...
#
# Generated by export_simulation on Wed Nov 26 23:14:43 -0600 2025
#
################################################################################
...
'-reset_run' switch to the './game_background_rom.sh' script.

./game_background_rom.sh -reset_run
...
./game_background_rom.sh -noclean_files

For more information on the script, please type './game_background_rom.sh -help'.
