...
#
# Generated by export_simulation on Fri Dec 12 01:40:30 -0600 2025
#
################################################################################
...
'-reset_run' switch to the './chickDie_rom.sh' script.

./chickDie_rom.sh -reset_run
...
./chickDie_rom.sh -noclean_files

For more information on the script, please type './chickDie_rom.sh -help'.
