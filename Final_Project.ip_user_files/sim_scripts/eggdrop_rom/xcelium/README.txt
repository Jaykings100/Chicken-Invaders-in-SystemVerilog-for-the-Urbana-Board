...
#
# Generated by export_simulation on Fri Dec 12 01:43:49 -0600 2025
#
################################################################################
...
'-reset_run' switch to the './eggdrop_rom.sh' script.

./eggdrop_rom.sh -reset_run
...
./eggdrop_rom.sh -noclean_files

For more information on the script, please type './eggdrop_rom.sh -help'.
