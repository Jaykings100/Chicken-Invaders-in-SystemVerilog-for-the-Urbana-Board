...
#
# Generated by export_simulation on Fri Dec 12 01:41:48 -0600 2025
#
################################################################################
...
'-reset_run' switch to the './shoot_rom.sh' script.

./shoot_rom.sh -reset_run
...
./shoot_rom.sh -noclean_files

For more information on the script, please type './shoot_rom.sh -help'.
