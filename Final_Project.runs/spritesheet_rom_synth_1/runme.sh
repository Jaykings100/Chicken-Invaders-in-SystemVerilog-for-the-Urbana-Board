...
HD_PWD='C:/Users/josei/Final_Project/Final_Project.runs/spritesheet_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spritesheet_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spritesheet_rom.tcl
