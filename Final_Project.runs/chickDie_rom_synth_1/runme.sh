...
HD_PWD='C:/Users/josei/Final_Project/Final_Project.runs/chickDie_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chickDie_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chickDie_rom.tcl
