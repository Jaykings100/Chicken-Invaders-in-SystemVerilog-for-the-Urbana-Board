...
HD_PWD='C:/Users/josei/Final_Project/Final_Project.runs/game_background_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_background_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_background_rom.tcl
