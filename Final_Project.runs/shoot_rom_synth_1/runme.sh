...
HD_PWD='C:/Users/josei/Final_Project/Final_Project.runs/shoot_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shoot_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shoot_rom.tcl
