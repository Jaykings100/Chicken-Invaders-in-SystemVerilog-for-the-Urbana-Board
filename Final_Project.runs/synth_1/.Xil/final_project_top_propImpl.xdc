set_property SRC_FILE_INFO {cfile:C:/Users/josei/Final_Project/Final_Project.srcs/constrs_1/imports/pin_assignment/mb_usb_hdmi_top.xdc rfile:../../../Final_Project.srcs/constrs_1/imports/pin_assignment/mb_usb_hdmi_top.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN B13 IOSTANDARD LVCMOS33 } [get_ports { audio_pwm_out }]; # AUDIO_PWM
set_property src_info {type:XDC file:1 line:92 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN C13 IOSTANDARD LVCMOS33 } [get_ports { audio_enable }];  # AUD_SD (Shutdown/Enable)
