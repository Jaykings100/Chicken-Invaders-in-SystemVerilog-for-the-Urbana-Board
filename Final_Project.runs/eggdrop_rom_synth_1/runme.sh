...
HD_PWD='C:/Users/josei/Final_Project/Final_Project.runs/eggdrop_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eggdrop_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eggdrop_rom.tcl
