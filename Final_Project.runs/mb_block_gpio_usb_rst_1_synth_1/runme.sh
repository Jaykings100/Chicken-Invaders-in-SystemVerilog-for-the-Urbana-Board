...
HD_PWD='C:/Users/josei/Final_Project.runs/mb_block_gpio_usb_rst_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_gpio_usb_rst_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_gpio_usb_rst_1.tcl
